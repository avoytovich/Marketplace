...
agent: ollama
model: llama3.1:8b
description: Analyze the repository and build a structural understanding (Ollama)
---

Your task is to analyze the repository and produce a high-level system understanding using Ollama.
